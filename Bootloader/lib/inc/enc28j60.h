...
#include <stdint.h>
//--------------------------------------------------
#define ENC_SELECT GPIOA->BSRR|=GPIO_BSRR_BR4
#define ENC_DESELECT GPIOA->BSRR|=GPIO_BSRR_BS4
#define ENC_RES_HIGH GPIOA->BSRR|=GPIO_BSRR_BS3
#define ENC_RES_LOW GPIOA->BSRR|=GPIO_BSRR_BR3
//--------------------------------------------------
//--------------------------------------------------
#define ENC28J60_MAXFRAME 1024
#define MAC_ADDR   {0x00,0xDB,0x70,0xD7,0x84,0xF9}
//--------------------------------------------------
